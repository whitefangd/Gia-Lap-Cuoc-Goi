 ...
 */
public class UCTextViewDateTime extends TextView {
     ...
     */
    public UCTextViewDateTime(Context context) {
        super(context);
        initLayout();
    }
     ...
     */
    public UCTextViewDateTime(Context context, AttributeSet attrs) {
        super(context, attrs);
        initLayout();
    }
     ...
     */
    public UCTextViewDateTime(Context context, AttributeSet attrs, int defStyle) {
     ...
     * {@link #UCTextViewDateTime(Context)}
     * {@link #UCTextViewDateTime(Context, AttributeSet)}
     * {@link #UCTextViewDateTime(Context, AttributeSet, int)}
     */
    private void initLayout() {
        if (!this.isInEditMode()) {
            this.setTypeface(UCTextViewDateTime.getTypeFace(getContext()));
        }
    }
    /**
     * P10: properties function
    ...
    private static Typeface getTypeFace(Context context) {
        if (UCTextViewDateTime.typeface == null) {
            UCTextViewDateTime.typeface = Typeface.createFromAsset(context.getAssets(), CommonConstant.EAssetsFonts.FONT_TABIHA.getFontPath());
        }
        return UCTextViewDateTime.typeface;
    }
}
